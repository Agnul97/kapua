...
public class DatastoreModule extends AbstractKapuaModule {
    ...
    private LowLevelSearchClientBuilderFactory lowLevelSearchClientBuilderFactory() {
        String engine = DatastoreElasticsearchClientSettings.getInstance().getString(DatastoreElasticsearchClientSettingsKey.CLIENT_ENGINE, "opensearch");
        return engine.equalsIgnoreCase("elasticsearch")
