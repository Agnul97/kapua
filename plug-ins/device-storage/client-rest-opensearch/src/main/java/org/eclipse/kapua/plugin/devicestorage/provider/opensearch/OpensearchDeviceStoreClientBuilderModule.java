...
/**
 * Contributes {@link OpensearchDeviceStoreClientBuilder} to the {@link java.util.Set} of {@link DeviceStoreClientBuilder}s that a consuming module
 ...
 * @since 2.1.0
 */
public class OpensearchDeviceStoreClientBuilderModule extends AbstractKapuaModule {
    ...
    @ProvidesIntoSet
    DeviceStoreClientBuilder opensearchDeviceStoreClientBuilder() {
        return new OpensearchDeviceStoreClientBuilder();
    }
}
